...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lio/appmetrica/analytics/impl/mf;Ljava/lang/String;Lio/appmetrica/analytics/coreutils/internal/services/SafePackageManager;)V
    .locals 0
    ...
    .line 3
    iput-object p2, p0, Lio/appmetrica/analytics/impl/I3;->b:Lio/appmetrica/analytics/impl/mf;
...
.method public final a()Ljava/util/List;
    ...
    .line 1
    iget-object v0, p0, Lio/appmetrica/analytics/impl/I3;->b:Lio/appmetrica/analytics/impl/mf;

    invoke-virtual {v0}, Lio/appmetrica/analytics/impl/mf;->f()Ljava/util/List;
    ...
    .line 9
    invoke-static {v1}, Landroidx/activity/ComponentDialog$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/PackageInfo;)Landroid/content/pm/SigningInfo;

    move-result-object v1

    .line 10
    invoke-static {v1}, Lcom/yandex/mobile/ads/impl/zv0$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/SigningInfo;)Z
    ...
    .line 11
    invoke-static {v1}, Lcom/yandex/mobile/ads/impl/zv0$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/SigningInfo;)[Landroid/content/pm/Signature;
    ...
    .line 13
    :cond_0
    invoke-static {v1}, Lcom/yandex/mobile/ads/impl/zv0$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/content/pm/SigningInfo;)[Landroid/content/pm/Signature;
    ...
    .line 32
    iget-object v1, p0, Lio/appmetrica/analytics/impl/I3;->b:Lio/appmetrica/analytics/impl/mf;

    invoke-virtual {v1, v0}, Lio/appmetrica/analytics/impl/mf;->a(Ljava/util/List;)Lio/appmetrica/analytics/impl/mf;
