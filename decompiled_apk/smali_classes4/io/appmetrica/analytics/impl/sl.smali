...
# interfaces
.implements Lio/appmetrica/analytics/impl/tn;
...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Lio/appmetrica/analytics/impl/sl;->d:J
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget-wide v1, Lio/appmetrica/analytics/impl/sl;->d:J
    ...
    iput-object v0, p0, Lio/appmetrica/analytics/impl/sl;->c:Lio/appmetrica/analytics/coreutils/internal/cache/CachedDataProvider$CachedData;

    .line 7
    iput-object p1, p0, Lio/appmetrica/analytics/impl/sl;->a:Landroid/content/Context;
    ...
    invoke-virtual {p1}, Lio/appmetrica/analytics/impl/Ka;->i()Lio/appmetrica/analytics/coreapi/internal/system/PermissionExtractor;

    move-result-object p1

    iput-object p1, p0, Lio/appmetrica/analytics/impl/sl;->b:Lio/appmetrica/analytics/coreapi/internal/system/PermissionExtractor;
...
.method public final bridge synthetic a()Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0}, Lio/appmetrica/analytics/impl/sl;->c()Ljava/util/List;
...
.method public final b()Lio/appmetrica/analytics/impl/nl;
    .locals 12
    ...
    .line 2
    iget-object v1, p0, Lio/appmetrica/analytics/impl/sl;->a:Landroid/content/Context;

    new-instance v2, Lio/appmetrica/analytics/impl/ol;

    invoke-direct {v2}, Lio/appmetrica/analytics/impl/ol;-><init>()V
    ...
    .line 3
    iget-object v2, p0, Lio/appmetrica/analytics/impl/sl;->a:Landroid/content/Context;
    ...
    .line 4
    iget-object v6, p0, Lio/appmetrica/analytics/impl/sl;->a:Landroid/content/Context;

    .line 9
    sget-object v10, Ljava/lang/Boolean;->FALSE:Ljava/lang/Boolean;

    new-instance v11, Lio/appmetrica/analytics/impl/rl;

    invoke-direct {v11, p0}, Lio/appmetrica/analytics/impl/rl;-><init>(Lio/appmetrica/analytics/impl/sl;)V
    ...
    new-instance v7, Lio/appmetrica/analytics/impl/ql;

    invoke-direct {v7}, Lio/appmetrica/analytics/impl/ql;-><init>()V
    ...
    .line 12
    invoke-direct {v0, v1, v2, v4, v3}, Lio/appmetrica/analytics/impl/nl;-><init>(Ljava/lang/Integer;Ljava/lang/Integer;ZLjava/lang/String;)V
...
.method public final declared-synchronized c()Ljava/util/List;
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lio/appmetrica/analytics/impl/sl;->c:Lio/appmetrica/analytics/coreutils/internal/cache/CachedDataProvider$CachedData;
    ...
    iget-object v1, p0, Lio/appmetrica/analytics/impl/sl;->c:Lio/appmetrica/analytics/coreutils/internal/cache/CachedDataProvider$CachedData;
    ...
    .line 5
    iget-object v1, v1, Lio/appmetrica/analytics/impl/Ka;->u:Lio/appmetrica/analytics/impl/mm;

    .line 6
    invoke-virtual {v1}, Lio/appmetrica/analytics/impl/mm;->b()Lio/appmetrica/analytics/impl/km;

    move-result-object v1

    .line 7
    iget-object v1, v1, Lio/appmetrica/analytics/impl/km;->n:Lio/appmetrica/analytics/impl/G4;
    ...
    .line 10
    iget-object v1, p0, Lio/appmetrica/analytics/impl/sl;->b:Lio/appmetrica/analytics/coreapi/internal/system/PermissionExtractor;
    ...
    .line 12
    invoke-static {v1}, Lio/appmetrica/analytics/impl/tl;->a(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 20
    invoke-virtual {p0}, Lio/appmetrica/analytics/impl/sl;->b()Lio/appmetrica/analytics/impl/nl;
