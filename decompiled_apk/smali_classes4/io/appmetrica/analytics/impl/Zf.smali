...
.method public constructor <init>(Lio/appmetrica/analytics/ecommerce/ECommerceProduct;)V
    ...
    invoke-direct {v0, v6}, Lio/appmetrica/analytics/impl/Pf;-><init>(Lio/appmetrica/analytics/ecommerce/ECommercePrice;)V
    ...
    :cond_1
    new-instance v5, Lio/appmetrica/analytics/impl/Pf;

    invoke-virtual {p1}, Lio/appmetrica/analytics/ecommerce/ECommerceProduct;->getOriginalPrice()Lio/appmetrica/analytics/ecommerce/ECommercePrice;

    move-result-object v6

    invoke-direct {v5, v6}, Lio/appmetrica/analytics/impl/Pf;-><init>(Lio/appmetrica/analytics/ecommerce/ECommercePrice;)V
    ...
    .line 8
    invoke-direct/range {v0 .. v7}, Lio/appmetrica/analytics/impl/Zf;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;Ljava/util/Map;Lio/appmetrica/analytics/impl/Pf;Lio/appmetrica/analytics/impl/Pf;Ljava/util/List;)V

    return-void
.end method

.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;Ljava/util/Map;Lio/appmetrica/analytics/impl/Pf;Lio/appmetrica/analytics/impl/Pf;Ljava/util/List;)V
    .locals 0
    ...
    .line 11
    iput-object p2, p0, Lio/appmetrica/analytics/impl/Zf;->b:Ljava/lang/String;

    .line 12
    iput-object p3, p0, Lio/appmetrica/analytics/impl/Zf;->c:Ljava/util/List;

    .line 13
    iput-object p4, p0, Lio/appmetrica/analytics/impl/Zf;->d:Ljava/util/Map;

    .line 14
    iput-object p5, p0, Lio/appmetrica/analytics/impl/Zf;->e:Lio/appmetrica/analytics/impl/Pf;

    .line 15
    iput-object p6, p0, Lio/appmetrica/analytics/impl/Zf;->f:Lio/appmetrica/analytics/impl/Pf;

    .line 16
    iput-object p7, p0, Lio/appmetrica/analytics/impl/Zf;->g:Ljava/util/List;
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lio/appmetrica/analytics/impl/Zf;->c:Ljava/util/List;
    ...
    iget-object v1, p0, Lio/appmetrica/analytics/impl/Zf;->d:Ljava/util/Map;
    ...
    iget-object v1, p0, Lio/appmetrica/analytics/impl/Zf;->e:Lio/appmetrica/analytics/impl/Pf;
    ...
    iget-object v1, p0, Lio/appmetrica/analytics/impl/Zf;->f:Lio/appmetrica/analytics/impl/Pf;
    ...
    iget-object v1, p0, Lio/appmetrica/analytics/impl/Zf;->g:Ljava/util/List;
