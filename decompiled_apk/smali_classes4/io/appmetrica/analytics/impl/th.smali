...
# instance fields
.field public final b:Lio/appmetrica/analytics/impl/Me;
...
# direct methods
.method public constructor <init>(Lio/appmetrica/analytics/impl/s5;Lio/appmetrica/analytics/impl/Me;)V
    .locals 9
    ...
    invoke-virtual {v0, v1}, Lio/appmetrica/analytics/impl/Wm;->a(Landroid/content/Context;)Lio/appmetrica/analytics/coreapi/internal/data/ProtobufStateStorage;
    ...
    .line 6
    invoke-direct/range {v2 .. v8}, Lio/appmetrica/analytics/impl/th;-><init>(Lio/appmetrica/analytics/impl/s5;Lio/appmetrica/analytics/impl/Me;Lio/appmetrica/analytics/coreapi/internal/data/ProtobufStateStorage;Lio/appmetrica/analytics/impl/K2;Lio/appmetrica/analytics/impl/i2;Lio/appmetrica/analytics/impl/D2;)V

    return-void
.end method

.method public constructor <init>(Lio/appmetrica/analytics/impl/s5;Lio/appmetrica/analytics/impl/Me;Lio/appmetrica/analytics/coreapi/internal/data/ProtobufStateStorage;Lio/appmetrica/analytics/impl/K2;Lio/appmetrica/analytics/impl/i2;Lio/appmetrica/analytics/impl/D2;)V
    .locals 0
    ...
    .line 8
    iput-object p2, p0, Lio/appmetrica/analytics/impl/th;->b:Lio/appmetrica/analytics/impl/Me;

    .line 9
    iput-object p3, p0, Lio/appmetrica/analytics/impl/th;->c:Lio/appmetrica/analytics/coreapi/internal/data/ProtobufStateStorage;

    .line 10
    iput-object p4, p0, Lio/appmetrica/analytics/impl/th;->d:Lio/appmetrica/analytics/impl/K2;

    .line 11
    iput-object p5, p0, Lio/appmetrica/analytics/impl/th;->e:Lio/appmetrica/analytics/impl/i2;

    .line 12
    iput-object p6, p0, Lio/appmetrica/analytics/impl/th;->f:Lio/appmetrica/analytics/impl/D2;
...
.method public final a(Lio/appmetrica/analytics/impl/l6;)Z
    ...
    .line 8
    iget-object v1, p0, Lio/appmetrica/analytics/impl/th;->c:Lio/appmetrica/analytics/coreapi/internal/data/ProtobufStateStorage;
    ...
    .line 12
    iget-object v4, p0, Lio/appmetrica/analytics/impl/th;->d:Lio/appmetrica/analytics/impl/K2;
    ...
    .line 17
    iget-object v7, p0, Lio/appmetrica/analytics/impl/th;->f:Lio/appmetrica/analytics/impl/D2;
    ...
    .line 24
    iget-object v8, p0, Lio/appmetrica/analytics/impl/th;->b:Lio/appmetrica/analytics/impl/Me;

    .line 25
    iget-object v9, p0, Lio/appmetrica/analytics/impl/jh;->a:Lio/appmetrica/analytics/impl/s5;
    ...
    .line 28
    new-instance v8, Lio/appmetrica/analytics/impl/hj;
    ...
    invoke-direct {v8, v9, v10}, Lio/appmetrica/analytics/impl/hj;-><init>(Landroid/content/Context;Lio/appmetrica/analytics/coreutils/internal/services/SafePackageManager;)V

    .line 30
    invoke-virtual {v8}, Lio/appmetrica/analytics/impl/hj;->a()Ljava/util/ArrayList;
    ...
    .line 32
    invoke-static {v3, v4}, Lio/appmetrica/analytics/impl/no;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iget-object v4, p0, Lio/appmetrica/analytics/impl/th;->e:Lio/appmetrica/analytics/impl/i2;
    ...
    .line 47
    iget-object p1, v0, Lio/appmetrica/analytics/impl/H9;->j:Lio/appmetrica/analytics/coreutils/internal/time/TimeProvider;

    invoke-interface {p1}, Lio/appmetrica/analytics/coreutils/internal/time/TimeProvider;->currentTimeSeconds()J

    move-result-wide v1

    iput-wide v1, v0, Lio/appmetrica/analytics/impl/H9;->l:J

    .line 48
    iget-object p1, v0, Lio/appmetrica/analytics/impl/H9;->a:Lio/appmetrica/analytics/impl/mf;

    invoke-virtual {p1, v1, v2}, Lio/appmetrica/analytics/impl/mf;->a(J)Lio/appmetrica/analytics/impl/mf;
    ...
    iget-object v3, p0, Lio/appmetrica/analytics/impl/th;->e:Lio/appmetrica/analytics/impl/i2;
    ...
    .line 58
    iget-object p1, p0, Lio/appmetrica/analytics/impl/th;->c:Lio/appmetrica/analytics/coreapi/internal/data/ProtobufStateStorage;
