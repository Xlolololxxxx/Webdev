...
.super Lio/appmetrica/analytics/impl/Wm;
.source "SourceFile"
...
.method public constructor <init>()V
    ...
    .line 1
    invoke-direct {p0}, Lio/appmetrica/analytics/impl/Wm;-><init>()V
...
.method public final a(Landroid/content/Context;Lio/appmetrica/analytics/coreapi/internal/data/IBinaryDataHelper;)Lio/appmetrica/analytics/coreapi/internal/data/ProtobufStateStorage;
    ...
    invoke-direct {v2}, Lio/appmetrica/analytics/impl/e2;-><init>()V
    ...
    invoke-static {v5}, Lio/appmetrica/analytics/impl/yj;->a(Ljava/lang/String;)[B
    ...
    .line 11
    invoke-static {p1}, Lio/appmetrica/analytics/impl/yj;->a(Ljava/lang/String;)[B
    ...
    invoke-direct {v1, v2, v3}, Lio/appmetrica/analytics/impl/V8;-><init>(Lio/appmetrica/analytics/coreapi/internal/data/ProtobufStateSerializer;Lio/appmetrica/analytics/coreutils/internal/encryption/AESEncrypter;)V
    ...
    invoke-direct {v2}, Lio/appmetrica/analytics/impl/H2;-><init>()V

    invoke-direct {p1, v2}, Lio/appmetrica/analytics/impl/a2;-><init>(Lio/appmetrica/analytics/impl/H2;)V

    .line 22
    const-string v2, "app_permissions_state"

    invoke-direct {v0, v2, p2, v1, p1}, Lio/appmetrica/analytics/impl/eg;-><init>(Ljava/lang/String;Lio/appmetrica/analytics/coreapi/internal/data/IBinaryDataHelper;Lio/appmetrica/analytics/coreapi/internal/data/ProtobufStateSerializer;Lio/appmetrica/analytics/coreapi/internal/data/ProtobufConverter;)V
...
.method public final c(Landroid/content/Context;)Lio/appmetrica/analytics/coreapi/internal/data/IBinaryDataHelper;
    ...
    .line 2
    :try_start_0
    iget-object v0, p1, Lio/appmetrica/analytics/impl/v7;->i:Lio/appmetrica/analytics/impl/p3;
    ...
    .line 6
    invoke-virtual {p1}, Lio/appmetrica/analytics/impl/v7;->g()Lio/appmetrica/analytics/coreapi/internal/data/IBinaryDataHelper;
    ...
    iput-object v0, p1, Lio/appmetrica/analytics/impl/v7;->i:Lio/appmetrica/analytics/impl/p3;
