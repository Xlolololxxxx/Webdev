...
.method static constructor <clinit>()V
    ...
    const-string v3, "PROVIDER_UNAVAILABLE"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lio/appmetrica/analytics/StartupParamsItemStatus;-><init>(Ljava/lang/String;I)V
    ...
    const-string v5, "INVALID_VALUE_FROM_PROVIDER"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lio/appmetrica/analytics/StartupParamsItemStatus;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lio/appmetrica/analytics/StartupParamsItemStatus;->INVALID_VALUE_FROM_PROVIDER:Lio/appmetrica/analytics/StartupParamsItemStatus;
    ...
    invoke-direct {v5, v7, v8}, Lio/appmetrica/analytics/StartupParamsItemStatus;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lio/appmetrica/analytics/StartupParamsItemStatus;->NETWORK_ERROR:Lio/appmetrica/analytics/StartupParamsItemStatus;

    .line 17
    new-instance v7, Lio/appmetrica/analytics/StartupParamsItemStatus;

    const-string v9, "FEATURE_DISABLED"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lio/appmetrica/analytics/StartupParamsItemStatus;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lio/appmetrica/analytics/StartupParamsItemStatus;->FEATURE_DISABLED:Lio/appmetrica/analytics/StartupParamsItemStatus;

    .line 21
    new-instance v9, Lio/appmetrica/analytics/StartupParamsItemStatus;

    const-string v11, "UNKNOWN_ERROR"

    const/4 v12, 0x5

    invoke-direct {v9, v11, v12}, Lio/appmetrica/analytics/StartupParamsItemStatus;-><init>(Ljava/lang/String;I)V

    sput-object v9, Lio/appmetrica/analytics/StartupParamsItemStatus;->UNKNOWN_ERROR:Lio/appmetrica/analytics/StartupParamsItemStatus;

    .line 25
    new-instance v11, Lio/appmetrica/analytics/StartupParamsItemStatus;

    const-string v13, "FORBIDDEN_BY_CLIENT_CONFIG"

    const/4 v14, 0x6

    invoke-direct {v11, v13, v14}, Lio/appmetrica/analytics/StartupParamsItemStatus;-><init>(Ljava/lang/String;I)V

    sput-object v11, Lio/appmetrica/analytics/StartupParamsItemStatus;->FORBIDDEN_BY_CLIENT_CONFIG:Lio/appmetrica/analytics/StartupParamsItemStatus;

    const/4 v13, 0x7

    .line 26
    new-array v13, v13, [Lio/appmetrica/analytics/StartupParamsItemStatus;
    ...
    .line 27
    sput-object v13, Lio/appmetrica/analytics/StartupParamsItemStatus;->a:[Lio/appmetrica/analytics/StartupParamsItemStatus;
